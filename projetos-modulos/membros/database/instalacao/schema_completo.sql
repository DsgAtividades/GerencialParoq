-- =====================================================
-- INSTALAÇÃO DAS TABELAS DO MÓDULO DE MEMBROS - VERSÃO CORRIGIDA
...
-- =====================================================
-- 7. ÍNDICES DE PERFORMANCE (APENAS SE NÃO EXISTIREM)
-- =====================================================

-- Índices para membros
CREATE INDEX IF NOT EXISTS idx_membros_nome ON membros_membros(nome_completo);
CREATE INDEX IF NOT EXISTS idx_membros_cpf ON membros_membros(cpf);
CREATE INDEX IF NOT EXISTS idx_membros_email ON membros_membros(email);
CREATE INDEX IF NOT EXISTS idx_membros_status ON membros_membros(status);
CREATE INDEX IF NOT EXISTS idx_membros_paroquiano ON membros_membros(paroquiano);

-- Índices para relacionamentos
CREATE INDEX IF NOT EXISTS idx_membros_pastorais_membro ON membros_membros_pastorais(membro_id);
CREATE INDEX IF NOT EXISTS idx_membros_pastorais_pastoral ON membros_membros_pastorais(pastoral_id);
CREATE INDEX IF NOT EXISTS idx_membros_pastorais_funcao ON membros_membros_pastorais(funcao_id);

-- Índices para eventos
CREATE INDEX IF NOT EXISTS idx_eventos_data ON membros_eventos(data_evento);
CREATE INDEX IF NOT EXISTS idx_eventos_tipo ON membros_eventos(tipo);
CREATE INDEX IF NOT EXISTS idx_eventos_ativo ON membros_eventos(ativo);

-- Índices para check-ins
CREATE INDEX IF NOT EXISTS idx_checkins_evento ON membros_checkins(evento_id);
CREATE INDEX IF NOT EXISTS idx_checkins_membro ON membros_checkins(membro_id);
CREATE INDEX IF NOT EXISTS idx_checkins_data ON membros_checkins(data_checkin);

-- Índices para auditoria
CREATE INDEX IF NOT EXISTS idx_auditoria_tabela ON membros_auditoria_logs(tabela);
CREATE INDEX IF NOT EXISTS idx_auditoria_registro ON membros_auditoria_logs(registro_id);
CREATE INDEX IF NOT EXISTS idx_auditoria_data ON membros_auditoria_logs(created_at);

-- =====================================================
-- 8. DADOS INICIAIS (APENAS SE NÃO EXISTIREM)
-- =====================================================
