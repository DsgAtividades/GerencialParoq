...
# -*- coding: utf-8 -*-
"""
Script simplificado para instalar as tabelas do módulo de Membros no banco principal gerencialparoq
...
class InstaladorSimples:
    ...
    def verificar_banco(self):
        ...
        try:
            ...
            if banco_atual != 'gerencialparoq':
                print("[AVISO] Nao esta conectado ao banco gerencialparoq")
                return False
            ...
            if tabelas_existentes > 0:
                print(f"[AVISO] Encontradas {tabelas_existentes} tabelas do modulo ja existentes")
                resposta = input("Deseja continuar mesmo assim? (s/N): ").lower()
                if resposta != 's':
                    print("[CANCELADO] Instalacao cancelada pelo usuario")
                    return False
        ...
        try:
            ...
            for i, statement in enumerate(statements, 1):
                ...
                try:
                    ...
                    erros += 1
                    print(f"  [ERRO] Erro no statement {i}: {e}")
    ...
    def instalar(self):
        ...
        print("[OK] Triggers de auditoria foram configurados")
