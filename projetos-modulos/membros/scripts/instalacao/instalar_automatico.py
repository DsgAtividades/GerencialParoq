...
# -*- coding: utf-8 -*-
"""
Script automático para instalar as tabelas do módulo de Membros no banco principal gerencialparoq
    ...
    def verificar_banco(self):
        ...
        try:
            ...
            if tabelas_existentes > 0:
                print(f"[INFO] Encontradas {tabelas_existentes} tabelas do modulo ja existentes")
                print("[INFO] Continuando com a instalacao...")
...
def main():
    """Função principal"""
    instalador = InstaladorAutomatico()
