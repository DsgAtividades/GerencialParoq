...
// Filtros
$data_inicio = isset($_GET['data_inicio']) ? $_GET['data_inicio'] : date('Y-m-d', strtotime("0 day", strtotime($dia_atual)));
$data_fim = isset($_GET['data_fim']) ? $_GET['data_fim'] : date('Y-m-d', strtotime("0 day", strtotime($dia_atual)));
        ...
        <div class="col-md-6">
            <div class="card h-100">
                <div class="card-header py-2">
                    <h5 class="card-title h6 mb-0">Top 5 Produtos Mais Vendidos</h5>
                </div>
