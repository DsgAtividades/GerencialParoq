<!--
    Arquivo de cabeçalho padrão do sistema Hamburger
    Você pode adicionar links de CSS, scripts e o menu principal aqui.
-->
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <title>Hamburger - Sistema</title>
    <!-- Adicione links de CSS, Tailwind ou outros scripts aqui -->
</head>
<body>
